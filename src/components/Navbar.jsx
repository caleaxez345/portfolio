...
function Navbar() {
    ...
    return (
        <div className="navbar bg-base-100 h-24">
            ...
            <details id="dropdown" className="dropdown dropdown-end">
                ...
                <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 lg:hidden">
                    <li><Link to='/' onClick={handleLinkClick}><IoHomeOutline size={20} /> Home</Link></li>
                    <li><Link to='/about-me' onClick={handleLinkClick}><GoPerson size={20} /> About Me</Link></li>
                    <li><Link to='/contact' onClick={handleLinkClick}><CiMail size={20} /> Contact</Link></li>
                    <li><Link to='/projects' onClick={handleLinkClick}><BsPersonWorkspace size={20} /> Projects</Link></li>
                </ul>
            </details>
            <div className="hidden lg:flex flex-none">
                <ul className="menu menu-horizontal px-1">
                    ...
                    <li><Link to='/'><IoHomeOutline size={25}/>Home</Link></li>
                    <li><Link to='/about-me'><GoPerson size={25}/> About Me</Link></li>
                    <li><Link to='/contact'><CiMail size={25} /> Contact</Link></li>
                    <li><Link to='/projects'><BsPersonWorkspace size={25} /> Projects</Link></li>
                </ul>
            </div>
        </div>
    );
